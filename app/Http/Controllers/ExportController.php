...
EOF
        ...
        foreach ($departmentWithTotalUserCount as $department => $totalUser) {
            $notReportedUserCountValue = array_key_exists($department, $notReportedUserCount) ? $notReportedUserCount[$department] : 0;
            fwrite($fp, "<tr>");
            ...
            fwrite($fp, "<td class='text'>" . number_format($notReportedUserCountValue / $totalUser * 100, "2") . "%</td>");
